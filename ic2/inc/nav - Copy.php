			...
			<div class="row">
				<div class="col-12">
					<nav class="navbar navbar-expand-md navbar-light">
						...
						<a class="navbar-brand" href="index.php"><h5 class="text-white k4 h2 text-transform-none" style="text-transform:none;">TakesMoney</h5></a>	
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							...
							<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4 ">
								...
								<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
									<a class="nav-link n9" href="courses"><i class="fa fa-book mr-1"></i>Courses</a>
								</li>
								<li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
